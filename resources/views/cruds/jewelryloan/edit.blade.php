	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body"> 
                <form action="{{ url('/inventory'."/".$products->id) }}" method="post">
					{!! csrf_field() !!}
                     @method("PATCH")

                    <div class="form-group has-feedback {{ $errors->has('item_type') ? 'has-error' : '' }}">
                        <label>Item Type</label>
                        <input value="{{$products->item_type}}" class="form-control" type="text" name="item_type">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('karat_gold') ? 'has-error' : '' }}">
                        ...
                        <input value="{{ $products->karat_gold }}" class="form-control" type="text" name="karat_gold">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('kind_of_stone') ? 'has-error' : '' }}">
                        ...
                        <input value="{{ $products->kind_of_stone }}" class="form-control" type="text" name="kind_of_stone">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('weight') ? 'has-error' : '' }}">
                        <label>Weight</label>
                        <input value="{{ $products->weight }}" class="form-control" type="number" name="weight">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('tag_price') ? 'has-error' : '' }}">
                        ...
                        <input value="{{ $products->tag_price }}" class="form-control" type="number" name="tag_price">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('amount') ? 'has-error' : '' }}">
                        <label>Amount</label>
                        <input value="{{ $products->amount }}" class="form-control" type="number" name="amount">
